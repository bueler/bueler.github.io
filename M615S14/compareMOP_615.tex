...
For the \python versions:  Type \verb|run expint.py| at the \ipython prompt or \verb|python expint.py| or \verb|./expint.py| at a shell prompt.  For the function \verb|bis.py|, run \python or \ipython and do: \verb|from bis import bis|.  In \ipython you can then do \verb|bis?| to get documentation for that function, and run the example as shown in the docstring.
