...
%          = 0                  otherwise.
% Because velocity is 1 and length of interval is 1, the duration
% t=k is the number of times the solution "wraps around" the interval.
%
% Demonstrates four schemes in subplots in one figure: upwind (top),
% Lax-Wendroff (next), and a flux-limited, nonlinear (bottom two).
% The last two subplots differ only in their time-integration scheme:
...
% The first and third arguments J (= number of subintervals) and k
