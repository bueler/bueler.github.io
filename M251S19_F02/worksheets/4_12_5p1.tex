...
\end{minipage} \hfill \begin{minipage}[t]{0.5\textwidth}\vspace{0pt} \includegraphics[width=\textwidth]{figs/slowtostop}\end{minipage}
\vspace{1.5in}
...
\noindent (b) \quad Using a graph of $y=\arctan x$, sketch a diagram which shows that
    $$\frac{5\arctan(5)}{2} \le \int_0^5 \arctan x\,dx \le \frac{5\pi}{2} \hspace{3.0in}$$
\vfill
